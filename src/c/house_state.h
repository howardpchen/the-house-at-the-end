...
#define HOUSE_HEARTH_DECAY_SECONDS (2 * 60)
#define HOUSE_HEARTH_MAX 5
#define HOUSE_HEARTH_LIT 1
#define HOUSE_HEARTH_SEEN 2
#define HOUSE_HEARTH_HELD 3
#define HOUSE_HEARTH_SHARED 5
